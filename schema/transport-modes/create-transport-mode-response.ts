...
const TransportMode: ObjectSchema = {
    ...
    schema: {
        type: "object",
        title: "CreateTransportModeResponse",
        description: "The root schema comprises the entire JSON document.",
        required: [
            "data"
        ],
        properties: {
            data: CommonSpecs.transportMode
        },
...
const GetAllTransportModesResponse100: ObjectSchema = extend(BaseResponse, TransportMode);

export const GetAllTransportModesResponse = versionSchemas(GetAllTransportModesResponse100);